describe('sort by button', () => {
  it('should generate a new set of sorted results', () => {
    cy.intercept(
      'GET',
      'https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=Breakfast&location=Los+Angeles,+CA&sort_by=rating&limit=10',
      { fixture: 'fakeSortByRatingResults.json' }
    ).as('sortByRatingResults');

    cy.intercept(
      'GET',
      'https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=Breakfast&location=Los+Angeles,+CA&sort_by=review_count&limit=10',
